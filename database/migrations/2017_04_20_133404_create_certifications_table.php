...
class CreateCertificationsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Certifications", 'certifications', 'title', 'fa-th-large', [
            ["title", "Title", "Name", false, "", 0, 12, false],
            ["logo", "Logo", "Image", false, "", 0, 0, false],
            ["sub_categories", "Sub categories", "Dropdown", false, "", 0, 0, false, "@sub_categories"],
            ["duration", "Duration", "Datetime", false, "", 0, 0, false],
        ]);

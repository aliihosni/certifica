...
class CreateSubCategoriesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Sub_categories", 'sub_categories', 'title', 'fa-align-center', [
            ["title", "Title", "TextField", false, "", 0, 12, false],
            ["logo", "Logo", "Image", false, "", 0, 0, false],
            ["categorie", "Categorie", "Dropdown", false, "", 0, 0, false, "@categories"],
        ]);

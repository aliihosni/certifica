...
class CreateResponsesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Responses", 'responses', 'content', 'fa-smile-o', [
            ["content", "Content", "Textarea", false, "", 0, 0, false],
            ["type", "Type", "Dropdown", false, "", 0, 0, false, ["Correct","Incorrect"]],
            ["question", "Question", "Dropdown", false, "", 0, 0, false, "@questions"],
        ]);

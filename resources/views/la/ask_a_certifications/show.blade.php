...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $ask_a_certification->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Ask_a_certifications", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/ask_a_certifications/'.$ask_a_certification->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Ask_a_certifications", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.ask_a_certifications.destroy', $ask_a_certification->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/ask_a_certifications') }}" data-toggle="tooltip" data-placement="right" title="Back to Ask a certifications"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'certification')
						@la_display($module, 'sub_category')
